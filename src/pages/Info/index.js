    ...
    <Fragment>
      ...
      <Container className="d-flex mt-5">
        ...
        <div className="content-main">
          ...
          <div
            style={{ padding: "15px" }}
            className="label d-flex flex-column justify-content-between"
          >
          ...
          <div
            style={{ padding: "15px" }}
            className="label d-flex justify-content-between align-items-center"
          >
            <div>
              <p className="med text-muted mb-2">Phone Number</p>
              <p className="bold big mb-0 d-none d-sm-inline">
            ...
            <div className="d-sm-block d-none">
              <Link
                to="/profile/info/phone"
                style={{ cursor: "pointer" }}
                className="med primary"
              >
                Manage
              </Link>
            </div>
