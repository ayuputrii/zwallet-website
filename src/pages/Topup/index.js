...
const Topup = (props) => {
  ...
  const { data, token20k, token50k, token100k } = useSelector(
    (state) => state.topup
  );
    ...
    <Fragment>
      ...
      <Container className="d-flex mt-5">
        ...
        <div className="content-main bg-white">
          ...
          <p className="med desc text-center d-sm-none mb-4">
          ...
          {!data
            ...
            : data.map((item, index) => {
                return (
                  <div key={index} className="label d-flex py-4">
                    <span className="text bold primary mr-3">
                      {item.sequence}
                    </span>
